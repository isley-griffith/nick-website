...
export default function About() {
  return (
    <div className="p-8 lg:pt-[0em] lg:pb-[8em] md:pb-[8em] mb-[8em] sm:mt-[2em]">
      <div className="grid w-full grid-cols-2 sm:grid-cols-1 sm:gap-8 xxs:gap-8 xxs:grid-cols-1 mobile:grid-cols-1 md:grid-cols-2 md:pt-24 sm:pt-12 xxs:pt-24 mobile:pt-36 mobile:gap-12">
        <div className="flex lg:items-end md:items-center lg:w-72 md:w-72">
          <div className="flex flex-col text-sm lg:mb-4 lg:ml-12 lg:-order-1 md:-order-1 sm:order-1 xxs:order-1 mobile:order-1 mobile:space-y-10 lg:space-y-28 md:space-y-8 sm:space-y-10 xxs:space-y-10">
            ...
            <div className="flex space-x-2">
              ...
              <span className="font-mono font-light">09-29-23</span>
            </div>
          </div>
        </div>
